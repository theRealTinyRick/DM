...
{
    public abstract class GameEvent<T, T1, T2, T3, T4> : UnityEvent<T1, T2, T3, T4>
    {
        ...
        public new void Invoke( T1 argument1, T2 argument2, T3 argument3, T4 argument4 )
        {
            sources.Push( source );

            try
            {
                base.Invoke( argument1, argument2, argument3, argument4 );
            }
        ...
        public void AddPersistentListener( UnityAction<T1, T2, T3, T4> listener )
        {
#if UNITY_EDITOR
            RemovePersistentListener( listener );

            UnityEventTools.AddPersistentListener<T1, T2, T3, T4>( this, listener );
#endif
        }

        public void RemovePersistentListener( UnityAction<T1, T2, T3, T4> listener )
        {
#if UNITY_EDITOR
            for( var _index = 0; _index < GetPersistentEventCount(); _index++ )
            {
                ...
                {
                    UnityEventTools.RemovePersistentListener<T1, T2, T3, T4>( this, listener );
                }
            }
#endif
        }
